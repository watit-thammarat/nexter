<template>
  <div class="container">
    ...
    <header class="header">
      ...
      <button class="header__btn btn">View our properties</button>
      <div class="header__seenon-text">As seen on</div>
      <div class="header__seenon-logos">
        <img src="img/logo-bbc.png" alt="Seeon on logo 1">
        <img src="img/logo-forbes.png" alt="Seeon on logo 2">
        <img src="img/logo-techcrunch.png" alt="Seeon on logo 3">
        <img src="img/logo-bi.png" alt="Seeon on logo 4">
      </div>
    </header>
    <div class="realtors">
      ...
      <div class="realtors__list">
        ...
        <div class="realtors__details">
          ...
          <p class="realtors__sold">245 houses sole</p>
        </div>

        <img src="img/realtor-2.jpeg" alt="" class="realtors__img">
        <div class="realtors__details">
          <h4 class="heading-4 heading-4--light">Kin Brown</h4>
          <p class="realtors__sold">212 houses sole</p>
        </div>

        <img src="img/realtor-3.jpeg" alt="" class="realtors__img">
        <div class="realtors__details">
          <h4 class="heading-4 heading-4--light">Toby ramsey</h4>
          <p class="realtors__sold">198 houses sole</p>
        </div>
      </div>
    </div>
    <section class="features">
      <div class="feature">
        ...
        <p class="feature__text">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Debitis, quaerat?</p>
      </div>
      <div class="feature">
        <svg class="feature__icon">
        ...
        <p class="feature__text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis quidem obcaecati sapiente iure ad nulla.</p>
      </div>
      <div class="feature">
        <svg class="feature__icon">
          <use xlink:href='img/sprite.svg#icon-map-pin'></use>
        </svg>
        <h4 class="heading-4 heading-4--dark">All hme sin in top locations</h4>
        <p class="feature__text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis quidem obcaecati sapiente iure ad nulla.</p>
      </div>
      <div class="feature">
        <svg class="feature__icon">
    ...
    <div class="story__pictures">
      ...
      <div class="story__content">
        ...
        <p class="story__text">
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Laboriosam explicabo, tempora architecto hic quia accusantium vel enim. Odit, nesciunt aspernatur!
        </p>
      ...
      <section class="homes">
        <div class="home">
          ...
          <button class="cta btn home__btn">Contact realtor</button>
        </div>
        <div class="home">
          ...
          <button class="cta btn home__btn">Cozy Country House</button>
        </div>
        <div class="home">
      ...
      <footer class="footer">
        <ul class="nav">
          ...
          <li class="nav__item"><a href="#" class="nav__link">Reqeust proposal</a></li>
